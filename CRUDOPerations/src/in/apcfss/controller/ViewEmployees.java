...
public class ViewEmployees extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) 
	{
		...
		try
		{
	        ...
	        out.print("<tr><th>Id</th><th>Name</th><th>qualification</th><th>gender</th><th>doj</th><th>Pancard</th><th>dob</th><th>salary</th>" +
	        		"<th>Edit</th><th>Delete</th><th>payslip</th></tr>");  
			for(Employee e:employeesList)
			{
				 out.print("<tr><td>"+e.getId()+"</td><td>"+e.getName()+"</td><td>"+e.getQualification()+"</td> " +
				 		"<td>"+e.getGender()+"</td><td>"+e.getDoj()+"</td><td>"+e.getPancard()+"</td><td>"+e.getDob()+"</td><td>"+e.getSalary()+"</td><td><a href='updateemp?id="+e.getId()+"'>edit</a></td>" +
